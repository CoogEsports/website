<footer class="pt-24 pb-9">
    <div class="mx-auto max-w-7xl mb-32">
        <div class="grid grid-cols-3 gap-4">
            <div>
                <img src="{{ Vite::asset('resources/images/logo.png') }}" class="mb-5 w-20">
                <p class="text-xl" style="color:#abafb2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis convallis tortor.</p>
            </div>

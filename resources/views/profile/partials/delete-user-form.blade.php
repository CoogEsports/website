<section>
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 bg-layer-600">
        <h2 class="text-white font-bold display-6 text-5xl mb-2 tracking-wider uppercase font-chakra">{{ __('Delete Account') }}</h2>
    </div>

    <div class="grid mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 bg-layer-700">

        <p class="text-layer-200 text-xl">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <h2 class="text-layer-100 text-xl mb-2">
                {{ __('Are you sure you want to delete your account?') }}
            </h2>

            <p class="text-layer-300 text-lg">
